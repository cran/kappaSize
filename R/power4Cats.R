Power4Cats <- function(kappa0, kappa1, props, raters=2, alpha=0.05, power=0.80)
{
#Error Checking
...
#Summary Method
summary.Power4Cats <- function(object, ...)
{
cat("Power-Based Sample Size Estimation for Studies of Interobserver Agreement with 4 Outcomes", "\n \n")
cat("Assuming:", "\n")
