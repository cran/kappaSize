CI4Cats <- function(kappa0, kappaL, kappaU=NA, props, raters=2, alpha=0.05)
{
...
#Summary Method
summary.CI4Cats <- function(object, ...)
{
cat("Confidence-Interval Based Sample Size Estimation for \n")
cat("Studies of Interobserver Agreement with Four Categorical Outcomes \n \n")
cat("Assuming:", "\n")
