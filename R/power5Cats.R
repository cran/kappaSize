Power5Cats <- function(kappa0, kappa1, props, raters=2, alpha=0.05, power=0.80)
{
#Error Checking
...
Results[5] <- ( P4(k=kappa1, p = props) - P4(k=kappa0, p = props) )^2/ P4(k=kappa0, p = props)
Results[6] <- ( P5(k=kappa1, p = props) - P5(k=kappa0, p = props) )^2/ P5(k=kappa0, p = props)
...
#Summary Method
summary.Power5Cats <- function(object, ...)
{
cat("Power-Based Sample Size Estimation for Studies of Interobserver Agreement with 5 Outcomes", "\n \n")
cat("Assuming:", "\n")
